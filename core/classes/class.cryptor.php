...
class Cryptor
{
     ...
     * @return string      The encrypted string.
     */
    public static function Encrypt($string, $key, $fmt = null)
    {
        $c = new Cryptor();
        return $c->encryptString($string, $key, $fmt);
    }
     ...
     * @return string      The decrypted string.
     */
    public static function Decrypt($string, $key, $fmt = null)
    {
        $c = new Cryptor();
        return $c->decryptString($string, $key, $fmt);
    }
}